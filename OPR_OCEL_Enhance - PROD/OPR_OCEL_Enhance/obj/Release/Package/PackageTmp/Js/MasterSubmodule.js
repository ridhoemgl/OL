...
function loadGrid() {
    ...
    $("#gridSubmodule").kendoGrid({
        ...
        columns: [
            ...
            { field: "MODULE_SUB_NAME", title: "Module Sub Name", width: "150px", attributes: { style: "text-align: left" } },
            { field: "MODULE_NAME", title: "Module", width: "150px", attributes: { style: "text-align: left" } },
            { field: "STEP", title: "Step", width: "70px", attributes: { style: "text-align: center" } },
            //{
            //    field: "IS_ACTIVE",
            //    title: "Status",
            //    width: "90px",
